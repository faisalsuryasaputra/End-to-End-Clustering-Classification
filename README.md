...
1. **Clone this repository:**
   ```bash
   git clone [https://github.com/faisalsuryasaputra/Customer-Segmentation-Prediction.git](https://github.com/faisalsuryasaputra/Customer-Segmentation-Prediction.git)
